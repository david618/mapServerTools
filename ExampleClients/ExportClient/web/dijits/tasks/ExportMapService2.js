dojo.provide("dijits.tasks.ExportMapService2");
...
var ExportMapService2 = {
    // _Templated dijit setup stuff
    templateString: dojo.cache("dijits.tasks.ExportMapService2", "templates/exportMapServiceTemplate.html"),
    ...
    _exportMapService: function()
    {
        try {
            ...
            console.log("outputFormat: " + formValues.outputFormat);
            ...
            var params = {
                ...
                "inOutputFormat": formValues.outputFormat,
                "inClip": formValues.clipFlag
            };
    ...
    _getFormValues: function()
    {
        ...
        var outputFormat = this.outputFormatComboBox.get("value");
...
dojo.declare("dijits.tasks.ExportMapService2", [dijit._Widget, dijit._Templated], ExportMapService2);
